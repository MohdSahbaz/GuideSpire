...
const guideData = [
  ...
  },
  {
    ...
    image: "https://cdn.wccftech.com/wp-content/uploads/2023/08/genshin-impact-4-scaled.jpg",
  },
  {
    id: 3,
    ...
    image: "https://cdn.akamai.steamstatic.com/steam/apps/2084970/capsule_616x353.jpg?t=1689652164",
  },
];

const LatestGuides = () => {
  return (
    <section className="bg-[#0F1A24] text-white px-4 py-12">
        ...
        {guideData.map((guide) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-300 mt-1">{guide.description}</p>
            </div>
            ...
            <img
              src={guide.image}
              alt={guide.title}
              className="w-full sm:w-[180px] h-[120px] object-cover rounded-lg"
            />
          </div>
        ))}
      </div>
